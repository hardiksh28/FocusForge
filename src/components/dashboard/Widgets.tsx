...
export const HeroHeader: FC<{ user?: any }> = ({ user }) => (
  ...
  >
    <div className="relative">
      <div className="w-24 h-24 rounded-full bg-gradient-to-br from-forge-accent to-forge-secondary p-1">
        <div className="w-full h-full rounded-full bg-forge-card flex items-center justify-center overflow-hidden text-5xl">
          {user?.avatar || '🦊'}
        </div>
      </div>
      <div className="absolute -bottom-1 -right-1 bg-amber-500 text-black text-[10px] font-black px-2 py-0.5 rounded-full border-2 border-forge-card">
        LVL {user?.level || 1}
      </div>
    </div>
    ...
    <div className="flex-1">
      <div className="flex justify-between items-end mb-4">
        <div>
          <h2 className="text-2xl font-bold mb-1">{user?.username || 'Hero'}</h2>
      ...
      <div className="grid grid-cols-2 gap-8 items-center">
        ...
        <div className="flex flex-col gap-6">
          <div className="flex items-center gap-4 group">
            ...
            <div>
              <p className="text-xl font-black leading-none tracking-tight">{totalFocusHrs} hrs</p>
          ...
          <div className="flex items-center gap-4 group">
            ...
            <div>
              <p className="text-xl font-black leading-none tracking-tight">{questsCompleted} tasks</p>
          ...
          <div className="flex items-center gap-4 group">
            ...
            <div>
              <p className="text-xl font-black leading-none tracking-tight">{dailyAvgHrs} hrs</p>
